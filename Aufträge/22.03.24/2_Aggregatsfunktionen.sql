...
INSERT INTO
    `lehrer`
VALUES
    (1, 'Schmitt', 'Beamter', 1, 3123),
    (2, 'Müller', 'Beamter', 2, 6581),
    (3, 'Maier', 'Angestellter', 3, 5224),
    (4, 'Bohnert', 'Beamter', 1, 3012),
    (5, 'Hunger', 'Beamter', 6, 4005),
    (6, 'Tschuck', 'Beamter', 6, 3612),
    (7, 'Betzold', 'Beamter', 3, 3902),
    (8, 'Metz', 'Angestellter', 4, 3385),
    (9, 'Hartz', 'Beamter', 4, 2451),
    (10, 'Schneider', 'Angestellter', 2, 1943),
    (11, 'Huber', 'Beamter', 5, 4054),
    (12, 'Lürcher', 'Angestellter', 6, 4504),
    (13, 'Bühler', 'Angestellter', 2, 3120),
    (14, 'Bohner', 'Angestellter', 4, 3904),
    (15, 'Ruck', 'Angestellter', 5, 3652),
    (16, 'Bock', 'Angestellter', 1, 1740),
    (17, 'Maler', 'Beamter', 1, 2403),
    (18, 'Mahler', 'Angestellter', 1, 2800),
    (19, 'Pfeffersack', 'Angestellter', 5, 2134),
    (20, 'Petersen', 'Beamter', 3, 3831),
    (21, 'Oettle', 'Beamter', 1, 3267),
    (22, 'Bercher', 'Angestellter', 6, 3091),
    (23, 'Bauer', 'Beamter', 5, 4188),
    (24, 'Pfeiffer', 'Angestellter', 3, 3241),
    (25, 'Bruns', 'Angestellter', 2, 3388),
    (26, 'Sauter', 'Beamter', 2, 2490),
    (27, 'Rauert', 'Beamter', 3, 2221),
    (28, 'Zelawat', 'Beamter', 4, 2991);
...
INSERT INTO
    `schueler`
VALUES
    (1, 'Anderson', 5, 3, 116, 'USA', 3, 2),
    (2, 'Archer', 1, 6, 118, 'USA', 6, 4),
    (3, 'Armstrong', 4, 3, 118, 'GB', 5, NULL),
    (4, 'Baker', 6, 1, 116, 'GB', 4, 5),
    (5, 'Barber', 2, 3, 120, 'USA', 5, 3),
    (6, 'Bennett', 4, 2, 250, 'GB', 5, 1),
    (7, 'Bishop', 5, 2, 250, 'USA', 4, 2),
    (8, 'Black', 1, 5, 250, 'USA', 2, 1),
    (9, 'Blair', 1, 2, 250, 'GB', 4, 1),
    (10, 'Brown', 4, 5, 118, 'GB', 4, 4),
    (11, 'Carter', 3, 5, 252, 'USA', 3, 1),
    (12, 'Chaplin', 5, 4, 117, 'GB', 3, 5),
    (13, 'Connor', 3, 5, 117, 'USA', 5, 1),
    (14, 'Edison', 4, 4, 250, 'USA', 5, 2),
    (15, 'Edwards', 2, 5, 120, 'GB', 4, 4),
    (16, 'Eliot', 2, 2, 116, 'GB', 6, 2),
    (17, 'Franklin', 5, 4, 118, 'USA', 4, NULL),
    (18, 'Garcia', 2, 3, 118, 'GB', 3, 3),
    (19, 'Hanson', 5, 5, 252, 'USA', 3, 5),
    (20, 'Harper', 4, 4, 118, 'USA', 5, 1),
    (21, 'Hernandez', 5, 5, 117, 'GB', 1, 4),
    (22, 'Hilton', 4, 2, 120, 'GB', 2, 4),
    (23, 'Hobbs', 3, 4, 117, 'USA', 4, 2),
    (24, 'Jackson', 4, 6, 116, 'GB', 2, 3),
    (25, 'Jameson', 2, 2, 117, 'USA', 3, 2),
    (26, 'Johnson', 1, 4, 250, 'USA', 4, 3),
    (27, 'Jones', 2, 3, 116, 'GB', 6, 5),
    (28, 'King', 3, 6, 120, 'GB', 3, 3),
    (29, 'Lopez', 6, 1, 251, 'USA', 6, 5),
    (30, 'Martinez', 5, 3, 118, 'GB', 3, 2),
    (31, 'Mason', 5, 2, 116, 'USA', 5, 2),
    (32, 'Mathewson', 2, 3, 251, 'USA', 3, 5),
    (33, 'Michaels', 5, 3, 250, 'GB', 4, 5),
    (34, 'Miller', 5, 5, 117, 'GB', 2, 1),
    (35, 'Moore', 4, 6, 117, 'USA', 2, 4),
    (36, 'Muller', 4, 5, 250, 'GB', 1, 1),
    (37, 'Nolan', 4, 4, 252, 'USA', 1, 4),
    (38, 'Parker', 5, 2, 116, 'USA', 2, 2),
    (39, 'Ramirez', 3, 5, 120, 'GB', 2, 3),
    (40, 'Rodriguez', 3, 5, 116, 'GB', 4, 3),
    (41, 'Sawyer', 1, 4, 117, 'USA', 5, 2),
    (42, 'Shoemaker', 3, 5, 116, 'GB', 6, 1),
    (43, 'Smith', 2, 2, 117, 'USA', 2, 3),
    (44, 'Stark', 1, 4, 252, 'USA', 4, 4),
    (45, 'Stone', 4, 6, 116, 'GB', 3, 3),
    (46, 'Thomas', 3, 5, 117, 'GB', 4, NULL),
    (47, 'Thompson', 1, 2, 116, 'USA', 5, 2),
    (48, 'Warren', 2, 4, 252, 'GB', 1, 2),
    (49, 'Ward', 5, 6, 250, 'USA', 5, 1),
    (50, 'Wayne', 3, 4, 116, 'USA', 2, 5),
    (51, 'West', 3, 5, 252, 'GB', 6, 4),
    (52, 'White', 3, 3, 120, 'GB', 3, 3),
    (53, 'Young', 3, 6, 118, 'USA', 5, 4),
    (54, 'Popow', 5, 4, 116, 'RU', 3, 2),
    (55, 'Sokolow', 3, 2, 116, 'RU', 5, 3),
    (56, 'Lebedew', 6, 4, 251, 'RU', 4, 5),
    (57, 'Koslow', 5, 6, 117, 'RU', 5, 2),
    (58, 'Nowikow', 3, 4, 252, 'RU', 4, 4),
    (59, 'Morosow', 4, 5, 251, 'RU', 3, 5),
    (60, 'Petrow', 2, 6, 117, 'RU', 5, 4),
    (61, 'Wolkow', 6, 1, 251, 'RU', 5, 1),
    (62, 'Solowjow', 4, 3, 250, 'RU', 2, NULL),
    (63, 'Wassiljew', 2, 2, 120, 'RU', 3, 5),
    (64, 'Saizew', 1, 5, 120, 'RU', 5, 2),
    (65, 'Pawlow', 2, 4, 117, 'RU', 2, 3),
    (66, 'Semjonow', 3, 5, 120, 'RU', 6, 2),
    (67, 'Golubew', 4, 5, 250, 'RU', 1, 2),
    (68, 'Winogradow', 5, 5, 252, 'RU', 3, 2),
    (69, 'Bogdanow', 5, 4, 252, 'RU', 3, 2),
    (70, 'Worobjow', 1, 2, 118, 'RU', 4, 4),
    (71, 'Fjodorow', 4, 2, 118, 'RU', 5, 2),
    (72, 'Michailow', 5, 4, 250, 'RU', 5, 3),
    (73, 'Beljajew', 4, 6, 116, 'RU', 5, 2),
    (74, 'Tarassow', 3, 1, 120, 'RU', 4, 4),
    (75, 'Below', 6, 3, 252, 'RU', 6, 2),
    (76, 'Komarow', 5, 3, 117, 'RU', 5, 1),
    (77, 'Orlow', 2, 3, 120, 'RU', 3, 1),
    (78, 'Kisseljow', 5, 6, 116, 'RU', 5, 2),
    (79, 'Makarow', 6, 2, 117, 'RU', 4, 2),
    (80, 'Andrejew', 6, 2, 252, 'RU', 3, 3),
    (81, 'Kowaljow', 6, 1, 251, 'RU', 5, 3),
    (82, 'Iljin', 4, 2, 250, 'RU', 3, 2),
    (83, 'Gussew', 2, 6, 117, 'RU', 2, 3),
    (84, 'Titow', 3, 4, 252, 'RU', 3, 5),
    (85, 'Kusmin', 2, 3, 117, 'RU', 6, 4),
    (86, 'Kudrjawzew', 3, 1, 250, 'RU', 2, 3),
    (87, 'Baranow', 2, 2, 118, 'RU', 4, 2),
    (88, 'Kulikow', 6, 2, 252, 'RU', 3, 1),
    (89, 'Alexejew', 1, 3, 116, 'RU', 2, 3),
    (90, 'Stepanow', 2, 2, 250, 'RU', 6, 3),
    (91, 'Jakowlew', 4, 5, 252, 'RU', 5, 1),
    (92, 'Sorokin', 4, 2, 116, 'RU', 2, 3),
    (93, 'Sergejew', 6, 4, 120, 'RU', 6, 3),
    (94, 'Romanow', 2, 5, 117, 'RU', 4, 1),
    (95, 'Sacharow', 4, 3, 117, 'RU', 4, 5),
    (96, 'Borissow', 2, 3, 251, 'RU', 5, NULL),
    (97, 'Koroljow', 4, 4, 252, 'RU', 6, 2),
    (98, 'Gerassimow', 5, 5, 250, 'RU', 4, 4),
    (99, 'Ponomarjow', 3, 5, 252, 'RU', 5, 3),
    (100, 'Grigorjew', 6, 3, 116, 'RU', 5, 4),
    (101, 'Smirnow', 2, 5, 116, 'RU', 5, 1),
    (102, 'Iwanow', 3, 1, 250, 'RU', 2, 2),
    (103, 'Kusnezow', 5, 3, 251, 'RU', 5, 2);
