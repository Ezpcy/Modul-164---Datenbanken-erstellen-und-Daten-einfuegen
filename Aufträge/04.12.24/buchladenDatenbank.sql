...
VALUES
    ...
    (
        3,
        'Mein Kaninchen, mein Bruder und ich',
        11.90,
        5.12,
        1965,
        2
    ...
    (
        5,
        'Wilde Jagd auf John Smith - Die Rache',
        15.90,
        7.11,
        1995,
        1
    ...
    (
        6,
        'Wilde Jagd auf John Smith - Die Vergeltung',
        23.95,
        15.35,
        2012,
        3
    ...
    (
        17,
        'Der Landarzt und seine Sekretärin',
        12.90,
        6.98,
        2001,
        2
    ...
    (
        22,
        'Foliant der Hildegard von Bingen - Faksimile',
        485.00,
        205.60,
        1957,
        6
...
CREATE TABLE
    `buecher_has_lieferanten` (
        `buecher_buecher_id` int (11) NOT NULL,
        `lieferanten_lieferanten_id` int (11) NOT NULL,
        PRIMARY KEY (
            `buecher_buecher_id`,
            `lieferanten_lieferanten_id`
        ),
